<x-app title="Berita">
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
            @if(!$pinnedNews && $news->isEmpty() && $popularNews->isEmpty() && $categories->isEmpty())
                {{-- Global empty state --}}
                <div class="flex flex-col items-center justify-center py-32 text-center bg-white rounded-2xl border border-gray-200">
                    ...
                    <p class="text-gray-700 font-semibold text-lg mb-1">Belum ada berita</p>
                    <p class="text-gray-400 text-sm">Belum ada berita yang dipublikasikan saat ini.<br>Silakan kembali lagi nanti.</p>
                </div>
            @else
                    ...
                    <section>
                        ...
                        <a href="{{ route('news.show', $pinnedNews->slug) }}"
                            ...
                            <div class="lg:w-3/5 aspect-video lg:aspect-auto overflow-hidden bg-gray-100">
                                <img src="{{ $pv?->thumbnail }}" alt="{{ $pv?->title }}" class="w-full h-full object-cover" />
                            </div>
                                ...
                                <div class="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                                    ...
                                    <div class="flex items-center gap-3 flex-1 min-w-0">
                                        @if($pinnedNews->author)
                                            <img src="{{ $pinnedNews->author->profile_photo }}"
                                ...
                                <div class="divide-y divide-gray-50">
                                    @foreach($popularNews as $i => $popular)
                                        ...
                                        <a href="{{ route('news.show', $popular->slug) }}"
                                            ...
                                            {{-- Nomor --}}
                                            <span
                                                class="shrink-0 w-6 h-6 rounded-lg flex items-center justify-center text-xs font-bold
